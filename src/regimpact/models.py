...
class ReasonCode(str, Enum):
    ...
    LTV_NONREG_OWNER_60 = "LTV_NONREG_OWNER_60"
    ...
    CONTRADICTION_OWNER_FIRST_HOME = "CONTRADICTION_OWNER_FIRST_HOME"
    CONTRADICTION_DISPOSAL_WITHOUT_HOUSE = "CONTRADICTION_DISPOSAL_WITHOUT_HOUSE"
    CONTRADICTION_DISPOSAL_MULTI_HOUSE = "CONTRADICTION_DISPOSAL_MULTI_HOUSE"
    INVALID_HOUSE_COUNT = "INVALID_HOUSE_COUNT"
