...
🟢 **Phase 1~2 진행** — 룰엔진 v1 + Extractor + TC Generator/Rule-Regression + Impact Matrix E2E(6·30 관통) 구현(테스트 56개 통과). 자세한 내용은 `docs/01_PROJECT_STATE.md` 참고.
