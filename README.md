...
| `src/regimpact/impact/` | **Impact Matrix E2E + 가중 합성 모집단** — before/after 차등 임팩트 + 문서화된 비중 가중 포트폴리오(수천 명 표본) |
...
🟢 **Phase 1~2 진행** — 룰엔진 v1 + Extractor + TC Generator/Rule-Regression + Impact Matrix E2E + HTML 리포트(6·30 관통) 구현(테스트 112개 통과). 자세한 내용은 `docs/01_PROJECT_STATE.md` 참고.
